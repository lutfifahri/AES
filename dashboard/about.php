        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-body">
                            <legend>Aplikasi Enkripsi dan Dekripsi SMK Dharma Patra</legend>
                            <p>Di era ini teknologi semakin maju dan pesat, dimana kerahasiaan data salah satunya yang sangat penting bagi sebuah perusahaan.<br>
                                ...
                                Aplikasi ini merupakan Aplikasi untuk menjaga kerahasiaan data-data penting di SMK Dharma Patra</p>
                        </div>
                    </div>
                </div>
            </div>
