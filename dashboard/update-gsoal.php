...
if ($iniuntukgambar != "") {
    ...
    if (in_array($ekstensi, $ekstensi_diperbolehkan) == true) {
        ...
        $queryUbah = mysqli_query($koneksi, "UPDATE pilihan_ganda SET Soal = '$Soal', Kunci_jawab='$Kunci_jawab', a='$a', b='$b', c='$c', d='$d', Foto='$nama_baru', Keterangan='$Keterangan', updated_at='$updated_at', User='$User' WHERE id='$id' ");
    ...
    # Syntak untuk update {Ubah}
    $queryUbah1 = mysqli_query($koneksi, "UPDATE pilihan_ganda SET Soal = '$Soal', Kunci_jawab='$Kunci_jawab', a='$a', b='$b', c='$c', d='$d', Keterangan='$Keterangan', updated_at='$updated_at', User='$User' WHERE id='$id' ");
