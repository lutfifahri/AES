...
<body class="sidebar-mini fixed">
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <div class="page-title">
                <div>
                    <h1><i class="fa fa-circle-o"></i>&nbsp;Data Jurusan</h1>
                </div>
                <div>
                    <ul class="breadcrumb">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <table id="file" class="table striped">
                                    ...
                                    $no = 1;
                                    $query = mysqli_query($koneksi, "SELECT * FROM jurusan WHERE Tipe!='Z' ");
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <center><a href="#" data-toggle="modal" data-target="#modalEdit<?php echo $a['id']; ?>" class="btn btn-info btn-sm"><i class="fa fa-tags"></i></a>&nbsp;<a href="hapus-Jurusan.php?id=<?php echo $a['id']; ?>" onclick="return confirm('Apakah anda yakin ingin menghapus data ini ?')" class="btn btn-danger btn-sm"><i class="fa fa-trash-o"></i></a></center>
                                            </td>
                                        </tr>
                                    <?php  } ?>
                                </table>
    ...
    <?php
    $kuery = mysqli_query($koneksi, "SELECT * FROM jurusan WHERE Tipe!='Z'");
            ...
            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <form action="update-Jurusan.php?id=<?php echo $b['id']; ?>" method="POST" autocomplete="off" id="formAdd" style="margin-bottom:0px" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group row" style="margin-bottom:8px">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="Jurusan" value="<?php echo $b['Jurusan']; ?>">
                                        </div>
                                    </div>
                            </div>
                        </div>
    ...
    <div id="modalTambah" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="aksi-jurusan.php" method="POST" autocomplete="off" id="formAdd" style="margin-bottom:0px">
                        <div class="form-group row" style="margin-bottom:8px">
                            <label for="Kode" class="col-sm-2 col-form-label">Kode</label>
                            <div class="col-sm-10">
                                <?php
                                # Mengambil data dengan kode yang paling besar
                                $query  = mysqli_query($koneksi, "SELECT max(Kode) as kodeTerbesar FROM jurusan WHERE Tipe!='Z'");
