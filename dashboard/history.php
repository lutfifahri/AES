    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <div class="page-title">
                <div>
                    <h1><i class="fa fa-list-alt"></i> History Aplikasi Enkripsi dan Dekripsi SMK Dharma Patra</h1>
                </div>
                <div>
                    <ul class="breadcrumb">
                                        ...
                                        while ($data = mysqli_fetch_array($query)) { ?>
                                            <tr>
                                                ...
                                                <td><?php if ($data['status'] == 1) {
                                                    ...
                                                    ?></td>
                                                <td><button onclick="JavaScript:window.location.href='download1.php?file=example.pdf';"> Download PDF</button><br /></td>
                                            </tr>
                                        <?php
                                        } ?>
                                    </tbody>
